...
# Legacy `_build_insider_trading_card` HTML helper tests removed: the v2
# renderer (production) does not display an insider-trading card, and the
# legacy renderer was deleted along with this helper.
