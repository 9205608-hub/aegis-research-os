...
# Legacy `_build_news_sentiment_card` HTML helper tests removed: the v2
# renderer (production) does not display news-sentiment cards, and the
# legacy renderer was deleted along with these helpers.
